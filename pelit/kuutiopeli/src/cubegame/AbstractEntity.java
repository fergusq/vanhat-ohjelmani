...
public abstract class AbstractEntity implements Entity {
	...
	private static final int PLAY_AREA_WIDTH = 92;
	...
	private static final int PLAY_AREA_HEIGHT = 92;
	...
	/** The z component of the velocity of this entity */
	protected float velocityZ = 0;
	
	/**
	 * @see org.newdawn.asteroids.entity.Entity#moveUpdate(org.newdawn.asteroids.entity.EntityManager, int)
	 */
	public void moveUpdate(EntityManager manager, int delta) {
		...
		positionZ += (velocityZ * delta) / 1000.0f;
