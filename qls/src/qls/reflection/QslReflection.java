...
public class QslReflection {
	private static LinkedList<String> packages = new LinkedList<String>();
	       ...
	       * @param args (QslValue[] : Types)
	       * @return
	       */
	      @SuppressWarnings("unchecked")
	      public static boolean existsSubroutine(Object classInstance, String methodName , QslValue ... args){
	          //~ Public Subroutine
	          try{
	              Class clazz = classInstance instanceof Class ? (Class)classInstance : classInstance.getClass();
	              
	              // Subtoutine with parameters "sub[param_,params_,...]"
	              if( args != null ){
	                  LinkedList<Class> classes = new LinkedList<Class>();
	                  for( QslValue value : args ){
	       ...
	       * @param args (QslValue[] : Method Arguments) 
	       * @return
	       */
	      @SuppressWarnings("unchecked")
	      public static Object invokeStaticSubroutine(Object classInstance, String methodName, QslValue ... args){
	          //~ Public Invokation
	          try{
	              Class clazz = classInstance instanceof Class ? (Class)classInstance : classInstance.getClass();
